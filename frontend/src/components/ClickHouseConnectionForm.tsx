  ...
  const testConnection = async () => {
    ...
    try {
      ...
      if (result.status === 'success' && result.connected) {
        setTestResult({ type: 'success', message: 'Подключение к ClickHouse успешно!' })
  ...
  return (
    <DatabaseContainer>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
        <div>
          <Label htmlFor="ch-host">Хост</Label>
          <Input
            id="ch-host"
            type="text"
        ...
        <div>
          <Label htmlFor="ch-port">Порт</Label>
          <Input
            id="ch-port"
            type="text"
            placeholder="8123"
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
        <div>
          <Label htmlFor="ch-username">Пользователь</Label>
          <Input
            id="ch-username"
            type="text"
            placeholder="default"
        ...
        <div>
          <Label htmlFor="ch-password">Пароль</Label>
          <Input
            id="ch-password"
            type="password"
            placeholder=""
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
        <div>
          <Label htmlFor="ch-database">База данных</Label>
          <Input
            id="ch-database"
            type="text"
            placeholder="default"
        ...
        <div>
          <Label htmlFor="ch-table">Таблица</Label>
          <Input
            id="ch-table"
            type="text"
